  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" :data="tableData" row-key="ID"
        ...
        <el-table-column align="left" label="入金金额" prop="valueIn" width="120" />
        <el-table-column align="left" label="金额" prop="value" width="120" />
        <el-table-column align="left" label="手续费" prop="fee" width="120" />
        <el-table-column align="left" label="金额单位" prop="valueType" width="120" />
        ...
        <el-table-column align="left" label="订单的状态" prop="status" width="120" >
        ...
        <el-table-column align="left" label="到账时间" width="180">
          <template #default="scope">{{ formatUpdateTime(scope.row.status, scope.row.UpdatedAt) }}</template>
        </el-table-column>
        <el-table-column align="left" label="操作">
          <template #default="scope">
          <div v-if="isStatusOp(scope.row.status)">
            <el-button type="primary"  class="table-button"
              @click="changePayStatusPaid(scope.row)">已支付</el-button>
            <el-button type="warning"  @click="changePayStatusUnPaid(scope.row)">未支付</el-button>
            </div>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="添加订单">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="200px">
        ...
        <el-form-item label="金额:" prop="valueIn">
          <el-input-number v-model="formData.valueIn" style="width:100%" :precision="2" :clearable="true" />
        </el-form-item>
