<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="名称" prop="name" width="250" />
        <el-table-column align="left" label="键" prop="key" width="200" />
        <el-table-column align="left" label="值" prop="value" width="120" />
        <el-table-column align="left" label="描述" prop="comment" width="360" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        <el-form-item label="名称:"  prop="name" >
          <el-input v-model="formData.name" :clearable="true"  placeholder="请输入" :disabled="isEdit" />
        </el-form-item>
        <el-form-item label="键:"  prop="key"   >
          <el-input v-model="formData.key" :clearable="true"  placeholder="请输入" :disabled="isEdit" />
        </el-form-item>
