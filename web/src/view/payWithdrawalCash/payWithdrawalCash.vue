  ...
  <div>
          ...
          <template #default="scope">
            <div v-if="isStatusOp(scope.row.status)">
              <el-button
                type="primary"
                class="table-button"
                @click="updatePayWithdrawalCashStatusSuccess(scope.row)"
                >提现成功</el-button
              >
              <el-button
                type="warning"
                @click="updatePayWithdrawalCashStatusFailed(scope.row)"
                >提现失败</el-button
              >
            </div>
          </template>
    ...
    >
      ...
      >
        ...
        <el-form-item
          v-if="formOp.showOpenFix"
          label="openfix_key:"
          prop="openpixKey"
        >
          <el-input
            v-model="formData.openpixKey"
            :clearable="true"
            placeholder="请输入"
          />
        </el-form-item>
...
const getTableData = async () => {
  const table = await getPayWithdrawalCashList({
    page: page.value,
