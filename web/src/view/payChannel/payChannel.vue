  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" :data="tableData" row-key="ID"
        ...
        <el-table-column align="left" label="渠道名称" prop="name" width="120" />
        <el-table-column align="left" label="渠道唯一标识" prop="identifier" width="120" />
        <!-- <el-table-column align="left" label="用户唯一标识" prop="identifier" width="120" /> -->
        ...
        <el-table-column align="left" label="按钮组">
          <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button"
              @click="updatePayChannelFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="120px">
        ...
        <el-form-item label="渠道名称:" prop="name" width="150">
          <el-input v-model="formData.name" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="渠道唯一标识:" prop="identifier" width="150">
          <el-input v-model="formData.identifier" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <!-- <el-form-item label="代理唯一标识:" prop="identifier" width="150">
          <el-input v-model="formData.identifier" :clearable="true" placeholder="请输入" />
        </el-form-item> -->
        <el-form-item label="描述:" prop="desc" width="150">
...
const getTableData = async () => {
  ...
  if (table.code === 0) {
    ...
    page.value = 1
    pageSize.value = 10
    if (table.data.list && table.data.list.length) {
...
const updatePayChannelFunc = async (row) => {
  ...
  for (var item of tableData.value) {
    formData.value = item
    dialogFormVisible.value = true
  }
  // tableData.value
  // if (res.code === 0) {
  //   formData.value = res.data.repayChannel
  //   dialogFormVisible.value = true
  // }
}
